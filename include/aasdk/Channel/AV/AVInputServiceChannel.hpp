...
private:
    ...
    void messageHandler(const messenger::Message::Pointer& message, IAVInputServiceChannelEventHandler::Pointer eventHandler);
    void handleAVChannelSetupRequest(const common::DataConstBuffer& payload, const IAVInputServiceChannelEventHandler::Pointer& eventHandler);
    void handleAVInputOpenRequest(const common::DataConstBuffer& payload, const IAVInputServiceChannelEventHandler::Pointer& eventHandler);
    void handleAVMediaAckIndication(const common::DataConstBuffer& payload, const IAVInputServiceChannelEventHandler::Pointer& eventHandler);
    void handleChannelOpenRequest(const common::DataConstBuffer& payload, const IAVInputServiceChannelEventHandler::Pointer& eventHandler);
};
