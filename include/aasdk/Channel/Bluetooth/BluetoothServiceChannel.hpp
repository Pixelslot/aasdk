...
private:
    ...
    void messageHandler(const messenger::Message::Pointer& message, IBluetoothServiceChannelEventHandler::Pointer eventHandler);
    void handleChannelOpenRequest(const common::DataConstBuffer& payload, const IBluetoothServiceChannelEventHandler::Pointer& eventHandler);
    void handleBluetoothPairingRequest(const common::DataConstBuffer& payload, const IBluetoothServiceChannelEventHandler::Pointer& eventHandler);
};
