...
private:
    ...
    void messageHandler(const messenger::Message::Pointer& message, IControlServiceChannelEventHandler::Pointer eventHandler);

    void handleVersionResponse(const common::DataConstBuffer& payload, const IControlServiceChannelEventHandler::Pointer& eventHandler);
    void handleServiceDiscoveryRequest(const common::DataConstBuffer& payload, const IControlServiceChannelEventHandler::Pointer& eventHandler);
    void handleAudioFocusRequest(const common::DataConstBuffer& payload, const IControlServiceChannelEventHandler::Pointer& eventHandler);
    void handleShutdownRequest(const common::DataConstBuffer& payload, const IControlServiceChannelEventHandler::Pointer& eventHandler);
    void handleShutdownResponse(const common::DataConstBuffer& payload, const IControlServiceChannelEventHandler::Pointer& eventHandler);
    void handleNavigationFocusRequest(const common::DataConstBuffer& payload, const IControlServiceChannelEventHandler::Pointer& eventHandler);
    void handlePingRequest(const common::DataConstBuffer& payload, const IControlServiceChannelEventHandler::Pointer& eventHandler);
    void handlePingResponse(const common::DataConstBuffer& payload, const IControlServiceChannelEventHandler::Pointer& eventHandler);
    void handleVoiceSessionRequest(const common::DataConstBuffer& payload, const IControlServiceChannelEventHandler::Pointer& eventHandler);
};
