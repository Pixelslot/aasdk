...
private:
    ...
    void messageHandler(const messenger::Message::Pointer& message, IInputServiceChannelEventHandler::Pointer eventHandler);
    void handleBindingRequest(const common::DataConstBuffer& payload, const IInputServiceChannelEventHandler::Pointer& eventHandler);
    void handleChannelOpenRequest(const common::DataConstBuffer& payload, const IInputServiceChannelEventHandler::Pointer& eventHandler);
};
