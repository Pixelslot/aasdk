...
class move_iterator {
 public:
  ...
  BOOST_MOVE_FORCEINLINE friend move_iterator operator+(difference_type n,
                                                        const move_iterator &x) { return move_iterator(x.m_it + n); }
...
template<class It>
BOOST_MOVE_FORCEINLINE move_iterator<It> make_move_iterator(const It &it) { return move_iterator<It>(it); }
