...
void NavigationChannel::messageHandler(const messenger::Message::Pointer& message,
...
void NavigationChannel::handleChannelOpenRequest(const common::DataConstBuffer& payload, const INavigationChannelEventHandler::Pointer& eventHandler)
{
