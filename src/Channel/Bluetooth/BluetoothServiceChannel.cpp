...
void BluetoothServiceChannel::messageHandler(const messenger::Message::Pointer& message, IBluetoothServiceChannelEventHandler::Pointer eventHandler)
{
    ...
    case proto::ids::BluetoothChannelMessage::PAIRING_REQUEST:
        this->handleBluetoothPairingRequest(payload, eventHandler);
        break;
    default:
...
void BluetoothServiceChannel::handleChannelOpenRequest(const common::DataConstBuffer& payload, const IBluetoothServiceChannelEventHandler::Pointer& eventHandler)
{
...
void BluetoothServiceChannel::handleBluetoothPairingRequest(const common::DataConstBuffer& payload, const IBluetoothServiceChannelEventHandler::Pointer& eventHandler)
{
