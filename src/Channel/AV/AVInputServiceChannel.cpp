...
void AVInputServiceChannel::messageHandler(const messenger::Message::Pointer& message, IAVInputServiceChannelEventHandler::Pointer eventHandler)
{
    ...
    case proto::ids::AVChannelMessage::AV_INPUT_OPEN_REQUEST:
        this->handleAVInputOpenRequest(payload, eventHandler);
        break;
    case proto::ids::AVChannelMessage::AV_MEDIA_ACK_INDICATION:
        this->handleAVMediaAckIndication(payload, eventHandler);
        break;
...
void AVInputServiceChannel::handleAVChannelSetupRequest(const common::DataConstBuffer& payload, const IAVInputServiceChannelEventHandler::Pointer& eventHandler)
{
...
void AVInputServiceChannel::handleAVInputOpenRequest(const common::DataConstBuffer& payload, const IAVInputServiceChannelEventHandler::Pointer& eventHandler)
{
...
void AVInputServiceChannel::handleAVMediaAckIndication(const common::DataConstBuffer& payload, const IAVInputServiceChannelEventHandler::Pointer& eventHandler)
{
...
void AVInputServiceChannel::handleChannelOpenRequest(const common::DataConstBuffer& payload, const IAVInputServiceChannelEventHandler::Pointer& eventHandler)
{
