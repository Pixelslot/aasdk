...
void AudioServiceChannel::messageHandler(const messenger::Message::Pointer& message, IAudioServiceChannelEventHandler::Pointer eventHandler)
{
...
void AudioServiceChannel::handleAVChannelSetupRequest(const common::DataConstBuffer& payload, const IAudioServiceChannelEventHandler::Pointer& eventHandler)
{
...
void AudioServiceChannel::handleStartIndication(const common::DataConstBuffer& payload, const IAudioServiceChannelEventHandler::Pointer& eventHandler)
{
...
void AudioServiceChannel::handleStopIndication(const common::DataConstBuffer& payload, const IAudioServiceChannelEventHandler::Pointer& eventHandler)
{
...
void AudioServiceChannel::handleChannelOpenRequest(const common::DataConstBuffer& payload, const IAudioServiceChannelEventHandler::Pointer& eventHandler)
{
...
void AudioServiceChannel::handleAVMediaWithTimestampIndication(const common::DataConstBuffer& payload, const IAudioServiceChannelEventHandler::Pointer& eventHandler)
{
