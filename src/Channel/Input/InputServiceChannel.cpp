...
void InputServiceChannel::messageHandler(const messenger::Message::Pointer& message, IInputServiceChannelEventHandler::Pointer eventHandler)
{
    ...
    case proto::ids::InputChannelMessage::BINDING_REQUEST:
        this->handleBindingRequest(payload, eventHandler);
        break;
...
void InputServiceChannel::handleBindingRequest(const common::DataConstBuffer& payload, const IInputServiceChannelEventHandler::Pointer& eventHandler)
{
...
void InputServiceChannel::handleChannelOpenRequest(const common::DataConstBuffer& payload, const IInputServiceChannelEventHandler::Pointer& eventHandler)
{
