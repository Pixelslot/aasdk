...
DataBuffer::DataBuffer(Data& _data, Data::size_type offset)
    : DataBuffer(_data.empty() ? nullptr : _data.data(), _data.size(), offset > _data.size() ? 0 : offset)
{
...
DataConstBuffer::DataConstBuffer(const Data& _data, Data::size_type offset)
    : DataConstBuffer(_data.empty() ? nullptr : _data.data(), _data.size(), offset > _data.size() ? 0 : offset)
{
